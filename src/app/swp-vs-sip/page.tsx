        ...
        <article className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-blue-50 rounded-lg p-6 border-2 border-blue-200">
                ...
                <p className="text-gray-600">
                  Invest small amounts regularly to <strong>build wealth</strong> over time.
                </p>
              </div>
              <div className="bg-green-50 rounded-lg p-6 border-2 border-green-200">
                <h3 className="text-xl font-bold text-green-800 mb-3">SWP</h3>
                <p className="text-gray-700 mb-2">
                  <strong>Systematic Withdrawal Plan</strong>
                </p>
                <p className="text-gray-600">
                  Withdraw fixed amounts regularly to <strong>generate income</strong> from investments.
                </p>
              </div>
            </div>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-3 text-gray-600">Existing lump sum investment</td>
                  </tr>
                  <tr className="bg-gray-50">
                  ...
                  <tr>
                    <td className="border border-gray-300 px-4 py-3 font-medium text-gray-800">Risk Approach</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-600">Rupee cost averaging</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-600">Regular income with growth potential</td>
                  </tr>
                  <tr className="bg-gray-50">
                  ...
                  <tr>
                    <td className="border border-gray-300 px-4 py-3 font-medium text-gray-800">Tax Treatment</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-600">Capital gains on redemption</td>
                    <td className="border border-gray-300 px-4 py-3 text-gray-600">Capital gains on each withdrawal</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>You&apos;re starting your investment journey</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>You have regular monthly income to invest</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>You want to build wealth over the long term (10+ years)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>You want to benefit from rupee cost averaging</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>You don&apos;t have a large lump sum to invest</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>You have a lump sum investment ready</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">•</span>
                    <span>You need regular monthly income (like a pension)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">•</span>
                    <span>You&apos;re retired or approaching retirement</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">•</span>
                    <span>You want to fund specific goals like education</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">•</span>
                    <span>You want disciplined withdrawal instead of ad-hoc redemption</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/what-is-swp"
                className="flex-1 bg-gray-100 hover:bg-gray-200 rounded-lg p-4 text-center transition-colors"
              >
                <span className="text-gray-800 font-medium">What is SWP? →</span>
              </Link>
              <Link
                href="/"
                className="flex-1 bg-blue-500 hover:bg-blue-600 rounded-lg p-4 text-center text-white transition-colors"
              >
