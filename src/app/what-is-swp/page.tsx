...
const articleJsonLd = {
  ...
  "description": "Learn what SWP (Systematic Withdrawal Plan) is, how it works, its benefits, and who should use it.",
  ...
  "mainEntityOfPage": { "@type": "WebPage", "@id": "https://swpcalculator.online/what-is-swp" }
};
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">What is SWP (Systematic Withdrawal Plan)?</h1>
            <p className="text-xl text-gray-600">A complete guide to understanding Systematic Withdrawal Plans in mutual funds</p>
          </header>

          <article className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Definition of SWP</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                A <strong>Systematic Withdrawal Plan (SWP)</strong> is a mutual fund facility that allows investors to withdraw a fixed amount from their investment at regular intervals. It&apos;s the opposite of SIP - instead of investing money periodically, you withdraw money periodically.
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">How Does SWP Work?</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Benefits of SWP</h2>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="text-blue-500 mr-3 text-xl">✓</span>
                  <div>
                    <strong className="text-gray-800">Regular Income:</strong>
                    <p className="text-gray-600">Receive a fixed amount every month for managing expenses.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-500 mr-3 text-xl">✓</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Choose your withdrawal amount, frequency, and duration.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-500 mr-3 text-xl">✓</span>
                  <div>
                    ...
                    <p className="text-gray-600">Long-term capital gains tax can be more efficient than income tax.</p>
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Who Should Use SWP?</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">Retirees</h3>
                  <p className="text-gray-600 text-sm">Need regular pension-like income from retirement corpus.</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">Parents</h3>
                  <p className="text-gray-600 text-sm">Funding children&apos;s education with monthly expenses.</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">Second Income Seekers</h3>
                  <p className="text-gray-600 text-sm">Create additional income stream from investments.</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">Conservative Investors</h3>
                  <p className="text-gray-600 text-sm">Prefer steady withdrawals over lump sum redemption.</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Things to Consider</h2>
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>• Monitor withdrawal rate vs. returns to avoid depleting capital</li>
                </ul>
              </div>
            </section>
          </article>
